    ...
    <div className="absolute inset-0 w-full h-full pointer-events-none z-[1] overflow-hidden flex items-center justify-center bg-surface-0">
      ...
      >
        ...
        <div className="absolute w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] lg:w-[700px] lg:h-[700px] border border-neon-cyan/10 rounded-full flex items-center justify-center shadow-[inset_0_0_80px_rgba(0,229,255,0.05)]">
          ...
          >
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface-1 border border-neon-cyan p-1.5 rounded shadow-glow-cyan">
              <SatelliteIcon className="w-4 h-4 text-neon-cyan" />
            </div>
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 bg-surface-1 border border-white/40 p-1 rounded">
          ...
          >
            <div className="absolute top-1/4 right-0 translate-x-1/2 bg-surface-1 border border-amber/70 p-1.5 rounded shadow-glow-amber">
          ...
          >
            <div className="absolute bottom-1/4 left-0 -translate-x-1/2 bg-surface-1 border border-crimson/70 p-1.5 rounded shadow-glow-crimson">
              <SatelliteIcon className="w-4 h-4 text-crimson" />
            </div>
            <div className="absolute top-1/2 right-0 translate-x-1/2 bg-surface-1 border border-neon-cyan/50 p-1 rounded">
          ...
          <div className="absolute top-1/4 right-[10%] font-mono text-[10px] sm:text-xs text-neon-cyan/60 hidden sm:block">
            <p>AZ: 145.2</p>
            <p>EL: +42.1</p>
            <p className="text-amber">SNR: LOW</p>
          </div>
          <div className="absolute bottom-1/4 left-[10%] font-mono text-[10px] sm:text-xs text-neon-cyan/60 hidden sm:block">
            <p>IONO: ACTIVE</p>
